...
Public Class Mrupload
                ...
                Using excelCommand As New OleDbCommand(selectQuery, excelConnection)
                    Using excelReader As OleDbDataReader = excelCommand.ExecuteReader()
                        ...
                        While excelReader.Read()
                            Dim insertQuery As String = "INSERT INTO tblMr (Pdno, Des, Qty, Date) " &
    ...
    Private Sub Mrupload_Load(sender As Object, e As EventArgs) Handles MyBase.Load
