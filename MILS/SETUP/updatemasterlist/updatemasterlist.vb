...
Public Class updatemasterlist
                ...
                Using excelCommand As New OleDbCommand(selectQuery, excelConnection)
                    Using excelReader As OleDbDataReader = excelCommand.ExecuteReader()
                        ...
                        While excelReader.Read()
                            Dim updateQuery As String = "UPDATE tblGoods " &
    "SET goodDes = @Column2 " &
    "WHERE id = @Column1"
                            ...
                            Using updateCommand As New SqlCommand(updateQuery, connection)
                                ...
                                updateCommand.Parameters.AddWithValue("@Column2", excelReader("goodDes"))
    ...
    Private Sub Updatemasterlist_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub Updatemasterlist_KeyDown(sender As Object, e As KeyEventArgs) Handles MyBase.KeyDown
